...
import 'models/plan_meal.dart' as _i13;
import 'screens/authentication/authentication_screen.dart' as _i2;
import 'screens/feedback/feedback_screen.dart' as _i6;
import 'screens/meal/meal_screen.dart' as _i9;
import 'screens/meal_create/meal_create_screen.dart' as _i8;
...
import 'screens/unknown_route/unknown_route_screen.dart' as _i10;
...
class AppRouter extends _i11.RootStackRouter {
  ...
  final Map<String, _i11.PageFactory> pagesMap = {
    ...
    MealCreateScreenRoute.name: (routeData) {
      ...
      return _i11.CupertinoPageX<dynamic>(
          routeData: routeData,
          child: _i8.MealCreateScreen(id: args.id, key: args.key));
    },
    MealScreenRoute.name: (routeData) {
      final args = routeData.argsAs<MealScreenRouteArgs>();
      return _i11.CupertinoPageX<dynamic>(
          routeData: routeData,
          child: _i9.MealScreen(id: args.id, key: args.key));
    },
    UnknownRouteScreenRoute.name: (routeData) {
      return _i11.CupertinoPageX<dynamic>(
          routeData: routeData, child: const _i10.UnknownRouteScreen());
    }
  };
  ...
  List<_i11.RouteConfig> get routes => [
        ...
        _i11.RouteConfig(AuthenticationScreenRoute.name,
            path: '/authentication-screen'),
        _i11.RouteConfig(SettingsScreenRoute.name, path: '/settings-screen'),
        _i11.RouteConfig(MealSelectScreenRoute.name,
            path: '/meal-select-screen'),
        _i11.RouteConfig(OnboardingScreenRoute.name,
            path: '/onboarding-screen'),
        _i11.RouteConfig(FeedbackScreenRoute.name, path: '/feedback-screen'),
        _i11.RouteConfig(UpcomingFeaturesScreenRoute.name,
            path: '/upcoming-features-screen'),
        _i11.RouteConfig(MealCreateScreenRoute.name, path: '/meal-create/:id'),
        _i11.RouteConfig(MealScreenRoute.name, path: '/meal/:id'),
        _i11.RouteConfig(UnknownRouteScreenRoute.name, path: '*')
      ];
}
...
class MealSelectScreenRoute
    extends _i11.PageRouteInfo<MealSelectScreenRouteArgs> {
  MealSelectScreenRoute(
      {required DateTime date, required _i13.MealType mealType, _i12.Key? key})
...
/// generated route for
/// [_i6.FeedbackScreen]
class FeedbackScreenRoute extends _i11.PageRouteInfo<void> {
...
class UpcomingFeaturesScreenRoute extends _i11.PageRouteInfo<void> {
...
/// generated route for
/// [_i8.MealCreateScreen]
class MealCreateScreenRoute
    extends _i11.PageRouteInfo<MealCreateScreenRouteArgs> {
  MealCreateScreenRoute({required String id, _i12.Key? key})
...
/// generated route for
/// [_i9.MealScreen]
class MealScreenRoute extends _i11.PageRouteInfo<MealScreenRouteArgs> {
  MealScreenRoute({required String id, _i12.Key? key})
...
/// generated route for
/// [_i10.UnknownRouteScreen]
class UnknownRouteScreenRoute extends _i11.PageRouteInfo<void> {
